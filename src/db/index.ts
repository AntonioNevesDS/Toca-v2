...
try {
  ...
  addColumnIfNotExists('pets', 'idade', 'TEXT');
  addColumnIfNotExists('pets', 'cor', 'TEXT');
  addColumnIfNotExists('pets', 'pelo', 'TEXT');
  addColumnIfNotExists('pets', 'sexo', 'TEXT');
  addColumnIfNotExists('pets', 'raca', 'TEXT');
